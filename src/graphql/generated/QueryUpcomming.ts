...
export interface QueryUpcomming_upcomingGame_cover {
  __typename: "UploadFile";
  url: string;
}

export interface QueryUpcomming_upcomingGame_developers {
  __typename: "Developer";
  name: string;
}

export interface QueryUpcomming_upcomingGame {
  __typename: "Game";
  id: string;
  name: string;
  slug: string;
  cover: QueryUpcomming_upcomingGame_cover | null;
  developers: QueryUpcomming_upcomingGame_developers[];
  price: number;
}
...
export interface QueryUpcomming {
  upcomingGame: QueryUpcomming_upcomingGame[];
